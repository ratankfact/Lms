...
const CreateBlogPost = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Blog post data:', newPost);
    ...
    // Generate the result after form submission
    setGeneratedResult(newPost);
  ...
  const handleDelete = (index) => {
    ...
    setPublishedPosts(updatedPosts);
    setGeneratedResult(null); // Clear generated result when deleting
  };
